...
local c_function_extractor = function(node)
    ...
    local has_return_statement = function()
        ...
        elseif res.function_declarator and (res.template_type or res.primitive_type or res.type_identifier) then
            if res.template_type then
                return { true }
            elseif res.type_identifier then
                return { true }
